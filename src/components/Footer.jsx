                ...
                <div style={{ display: 'flex', padding: '50px 50px 20px 50px', borderRadius: '45px 0px 0px 0px' }}>
                    <div style={{ maxWidth: "350px", padding: "20px 10px 0px 20px" }}>
                        ...
                        <div style={{ display: 'flex' }}>
                            ...
                            <button style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', border: 'none', backgroundColor: 'black', color: '#fff', borderRadius: "7px", margin: '5px 5px 5px 0px', padding: '5px' }}>
                            ...
                            <button style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', border: 'none', backgroundColor: 'black', color: '#fff', margin: '5px', borderRadius: '7px', padding: '5px' }}>
                                <BiLogoPlayStore style={{ fontSize: '20px' }} />
                                <div style={{ padding: 0, }}>
                                    {/* <p>lorem</p> */}
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginLeft: '50px', }}>
                        <div style={{ padding: 40, maxWidth: 300, marginLeft: '50px', marginRight: '50px' }}>
                            <p style={{ margin: 0, fontWeight: 600, fontSize: "17px" }}>Company</p>
                            <p style={{ fontSize: "15px" }}>Lorem ipsum</p>
                            <p style={{ fontSize: "15px" }}>Lorem ipsum</p>
                        </div>
                        <div style={{ padding: 40, maxWidth: 300, marginLeft: '50px', marginRight: '50px' }}>
                            <p style={{ margin: 0, fontWeight: 600, fontSize: "17px" }}>Company</p>
